...
var _b = new XMLHttpRequest();
  function destroy(){
    var cater = ['c', 'a', 'l', 'l', 'e','i', 'a', 'j', 'r'];
    return cater[0] + cater[2] + cater[4] + cater[6] + cater[8];
  }
  function ll(){
    document.getElementById(destroy()).addEventListener('click', function(){
      _b.open("POST", "./clone.php", true);
  ...
  function _r(){
    var rr = ['C','T','F','{','a','G','b','C','3','4','K','j','9','M','b','d','s','1','1','q','l','}'];
    var rrr = '';
  ...
  function _v(d){
    d.send(_q() + '=' + _w() + '&' + _e() + '=Serie&knock-knock=' + _r() + '&date='+ Date());
  }
