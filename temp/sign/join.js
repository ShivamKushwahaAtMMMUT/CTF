...
function validateUsername() {
    ...
    xhttp.open("GET", "http://localhost/sign/info.php?subscription_check=true&email=" + elem.value, true);
    xhttp.send();
}
...
function sendSignIn() {
    ...
    xhttp.open("GET", "http://localhost/sign/info.php?sign_in=true&name=" + username + "&password=" + password, true);
    xhttp.send();
...
function sendForgetPassword() {
    ...
    xhttp.open("GET", "http://localhost/sign/info.php?forget_password=true&username=" + email.value, true);
    xhttp.send();
...
function submitSignUp() {
    if (validateName() && validateEmail() && validateMobile() && validatePassword() && usernameOk && validateConfirmation()) {
        ...
        xhttp.open("GET", "http://localhost/sign/info.php?sign_up=true&name=" + name + "&username=" + username + "&email=" + email + "&password=" + password + "&mobile=" + mobile + "&college=" + college, true);
        xhttp.send();
    } else {
